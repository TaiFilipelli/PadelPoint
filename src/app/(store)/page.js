  ...
  return (
    <main className="flex flex-col items-center justify-between py-8 bg-[#264492]">
      ...
      <div className="flex flex-col text-right max-[500px]:text-left justify-end max-[500px]:justify-start items-end max-[500px]:items-start p-1 ml-80 max-[700px]:ml-60 max-[600px]:ml-40 max-[500px]:ml-0 mb-4 animate-appear">
        ...
        <Image src="/PadelPoint_IMGS/paletas3.jpg" width={600} isBlurred/>
      </div>
      </section>
      <Divider />
      ...
      <div className="flex flex-row w-1/2 justify-around items-center my-10 animate-appear">
        <Button as={Link} href="https://www.instagram.com/_padelpoint/" aria-label="Página oficial de Instagram" className="flex items-center p-5 rounded-lg bg-transparent hover:bg-gradient-to-tr from-[#FFDC80] to-[#E1306C] transition-all duration-300 ease-in-out" startContent={<InstagramLogo size={40} color="white"/>}>
          <p className="font-bold text-lg text-white">Instagram</p>
        </Button>
        <Button as={Link} href="https://api.whatsapp.com/send/?phone=%2B543364003555&text&type=phone_number&app_absent=0" aria-label="WhatsApp de PadelPoint" className="flex items-center p-5 bg-transparent hover:bg-gradient-to-tr from-[#25D366] to-[#128C7E] transition-all duration-300 ease-in-out rounded-lg" startContent={<WhatsappLogo size={40} color="white" />}>
