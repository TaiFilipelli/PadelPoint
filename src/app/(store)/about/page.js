...
export default function About() {
    ...
    const itemClasses = {
        ...
        trigger: "px-2 py-0 rounded-lg h-14 flex items-center bg-gray-300",
    ...
    return (
        <section className={`flex flex-col justify-center text-left items-center p-16 max-[390px]:px-8 ${pop.className} bg-[#264492]`}>
            ...
            <Accordion variant="bordered" className="bg-gray-300" itemClasses={itemClasses}>
            ...
            <Accordion variant="bordered" className="bg-gray-300" itemClasses={itemClasses} id="faq">
                ...
                <AccordionItem key='pedido' aria-label="¿Cuánto tiempo tarda en despacharse mi pedido después de realizar la compra?" indicator={<CaretRight size={20}/>} title='¿Cuánto tiempo tarda en despacharse mi pedido después de realizar la compra?'>
