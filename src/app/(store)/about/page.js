    ...
    return (
        <section className={`flex flex-col justify-center text-left items-center p-20 ${pop.className}`}>
            ...
            <Accordion variant="bordered" itemClasses={itemClasses}>
                <AccordionItem key='inspiracion' aria-label="Nuestra inspiración" indicator={<CaretDown size={20}/>} title='Nuestra inspiración'>
                ...
                <AccordionItem key='mision' aria-label="Nuestra misión" indicator={<CaretDown size={20}/>} title='Nuestra misión y diferencias'>
                ...
                <AccordionItem key='future' aria-label="Nuestro futuro" indicator={<CaretDown size={20}/>} title='Nuestro futuro'>
