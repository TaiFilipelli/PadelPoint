  ...
  return (
    <main className="flex items-center flex-col">
        ...
        <div className="w-1/2 flex justify-between gap-5 mb-5">
          ...
          <Button radius="large" as={Link} href='/dashboard/edit' variant='shadow' startContent={<Plus size={25}/>} className='w-[12rem] h-[3rem] bg-gradient-to-br from-cyan-300 to-violet-300 text-lg'>Añadir</Button>
