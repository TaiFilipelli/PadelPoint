...
return (
    ...
    {accessories.map(accessorie =>(
        <div key={accessorie.id} className="flex flex-row justify-between items-center gap-4 w-1/2 max-[470px]:w-full my-4 text-black bg-default-100 p-4 rounded-3xl">
