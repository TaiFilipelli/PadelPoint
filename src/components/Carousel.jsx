...
const MyCarousel = () => {
  return (
    <section className="p-5 w-full">
     <Carousel stopOnHover swipeable autoPlay showThumbs={false} axis="horizontal" infiniteLoop showArrows useKeyboardArrowsshowStatus={false}>
       <div className="flex justify-center items-center w-full max-h-[850px]">
          <img src="/PadelStock1.png" alt="Imagen de Stock PadelPoint" className="object-cover max-w-full h-auto"/>
        </div>
