...
const Footer = () => {
  ...
  return (
    <section className='absolute bottom-0 font-poppinsRegular flex flex-row items-center text-center p-4 w-full opacity-50 justify-between z-0 max-[1078px]:opacity-0'>
        ...
        <WhatsappLogo size={45}/><p className=''>3364 00-3555</p>
